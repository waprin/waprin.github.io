...
The most important things to know in order to read the examples below is that we use significant whitespace indentation instead of braces, we use "(x) ->"" instead of "function (x) { ", and "@"" is a shorthand for 'this.'.
